...
answer="Control flow analysis is how TypeScript dynamically figures out what type it should infer."
additional_feedback="
...
read -p "
  Convert the following code into OOP class.
...
Enter your answer: " response
answer="abstract class Tree { abstract toString(): string; }"
additional_feedback="
...
Enter the next line: " response
answer="class Empty extends Tree { toString() { return 'Empty'; } }"
additional_feedback="
...
Enter the next line: " response
answer="class Leaf extends Tree { }"
additional_feedback="
      type Tree = 
          | { type: 'empty' }
          | { type: 'leaf', value: number }
...
Enter the next line: " response
answer="constructor(private value: number) { super(); }"
additional_feedback="
...
Enter the next line: " response
answer="class Node extends Tree { }"
additional_feedback=""
evaluate_answer_written_with_code "$response" "$answer" "$additional_feedback" 
...
Enter the next line: " response
answer="constructor(private left: Tree, private right: Tree) { super(); }"
additional_feedback="
     type Tree = 
          | { type: 'empty' }
          | { type: 'leaf', value: number }
